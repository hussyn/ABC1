...
class BankAccount1
{
     ...
     */
    public BankAccount1(String acctNum, double initialBalance)
    {
        accountNum = acctNum;
...
public class BankAccountTest2
{
    ...
    public static void main(String[] args)
    {
        ...
        BankAccount1 first = new BankAccount1("1111111", 20000);
        BankAccount1 second = new BankAccount1("2222222", 30000);
