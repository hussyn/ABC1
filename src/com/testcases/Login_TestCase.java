...
public class Login_TestCase{
	...
	public static WebDriver setup_Browser() {
		...
		driver.get("file:///E:/software%20KS/Selenium%20Software/offline_website/offline%20website/index.html");
		return driver;
	...
	public static void Verify_Url() {
		...
		// expected url
		String expected_url = "file:///F:/IMP/Selenium/Offline%20Website%20_%20new/index.html";
	...
	public void verify_Title() {
		String stitle = driver
				.findElement(By.xpath("html/body/div[1]/div[1]/a")).getText();
		String exp = "AdminLTE";
	...
	public void loginsesion() {
		driver.findElement(By
				.xpath("//p[contains(text(),'Sign in to start your session')]"));
	...
	public void Check_PlaceHolder_Username() {
		String str = driver.findElement(By.xpath("html/body/div[1]/div[2]/form/div[1]/input"))
	...
	public void Check_PlaceHolder_Password() {
		String str = driver.findElement(By.xpath("html/body/div[1]/div[2]/form/div[2]/input"))
				.getAttribute("placeholder");
		String exp = "Password";
		Assert.assertEquals(str, exp);
	...
	public void check_Button_color() {
		WebElement signbtn = driver
				.findElement(By
						.xpath("html/body/div[1]/div[2]/form/div[3]/div/button"));
		System.out.println("befor mouse over button color is "
				+ signbtn.getCssValue("background-color"));
	...
	public void blank_username_password() {
		...
		String uname = driver.findElement(By.xpath("//div[@id='email_error']"))
				.getText();
		System.out.println(uname);
		String password = driver.findElement(
				By.xpath("//div[@id='password_error']")).getText();
	...
	public static void Verify_Url_DashBoard() {
		...
		// expected url
		String expected_url = "file:///F:/IMP/Selenium/Offline%20Website%20_%20new/pages/examples/dashboard.html";
		Assert.assertEquals(my_url, expected_url);
	...
	public void Fill_Form() throws InterruptedException {
		...
		email.sendKeys("Sanjivaniskakad@gmail.com");
		Thread.sleep(2000);
		WebElement gender = driver.findElement(By
				.xpath("//input[@id='Female']"));
		gender.click();
		Thread.sleep(2000);

		WebElement we = driver
				.findElement(By
						.xpath("html/body/div[1]/div[1]/section[2]/div/div/div/form/div[1]/div[5]/div/select"));
		Select s = new Select(we);
		s.selectByVisibleText("Maharashtra");
		WebElement password = driver.findElement(By
				.xpath("//input[@id='password']"));
		password.sendKeys("sanju");
		Thread.sleep(2000);
	...
	public void clickOn_OperatorBtn() throws InterruptedException {
		...
		WebElement Table1 = driver.findElement(By
				.xpath("//div[@class='box-body table-responsive no-padding']"));
	...
	public void logOutBtn() {
		driver.findElement(By.xpath("//span[contains(text(),'Logout1')]"))
				.click();
